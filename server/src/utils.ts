/**
 * Constructs an authorization URL for an upstream OAuth service (GitHub).
 */
...
/** Auth context stored in the OAuth token and provided to the MCP agent as this.props */
export type Props = {
  login: string;
  name: string;
  email: string;
